...
parser.add_argument('-e', '--env-id', type=str, default="Simple",
                    help="Environment id")
parser.add_argument('-l', '--log-dir', type=str, default="./MBWang_onestep",
...
def run():
    ...
    cmds, notes = create_commands("wang", args.num_workers, args.remotes, args.env_id, args.log_dir, mode=args.mode, visualise=args.visualise)
    if args.dry_run:
